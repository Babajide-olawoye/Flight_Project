...
public class FlightConfig {
	...
	CommandLineRunner commandLineRunner (FlightRepository repository) {
		return args ->{
			...
			repository.saveAll(
					List.of(sevdub1, sevdub2, sevdub3, sevlon1, sevlon2, sevlon3, sevber1, sevber2, sevber3, dubvil1, dubvil2, 
							dubvil3, dublon1, dublon2, dublon3, lonber1, lonber2, lonber3, lonvil1, lonvil2, lonvil3, vilber1, 
							vilber2, vilber3, dubsev1, dubsev2, dubsev3, lonsev1, lonsev2, lonsev3, bersev1, bersev2, bersev3, 
							vildub1, vildub2, vildub3, londub1, londub2, londub3, berlon1, berlon2, berlon3, villon1, villon2, 
							villon3, bervil1, bervil2, bervil3)
					);
		};
	}
